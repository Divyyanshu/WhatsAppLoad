...
//           animated: true,
//         });
//       }, 100); // small delay to ensure SectionList is rendered
//     }
//   }, [sections]);
...
//       // Assume result is an array; adjust to result.Data if needed
//       let newChats = Array.isArray(result) ? result : [];
...
//   // Trigger fetch only on refresh (e.g., from Templates after send)
//   useEffect(() => {
//     if (refresh) {
//       fetchChats();
//     }
