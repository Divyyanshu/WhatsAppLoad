...
//   const wse = useRef(null);
//   const receivedUids = useRef(new Set());
//   const { user } = useContext(UserContext);
//   const navigation = useNavigation();
//   const wsUrl = `wss://www.loadcrm.com/whatsappwebsocket/wse/chat?senderNumber=${user.WhatsAppSenderID}&receiverNumber=${number}&sysIpAddress=192.168.1.100&user=app`;
...
//       wse.current = null;
//     }
//     wse.current = new WebSocket(wsUrl);

//     wse.current.onopen = () => {
//       console.log('WebSocket Connected');
//       fetchChats();
//     };
//     wse.current.onmessage = e => {
//       try {
...
//       }
//     };
//     wse.current.onerror = err =>
//       console.error('WebSocket Error:', err?.message || err);
//     wse.current.onclose = e =>
//       console.warn('WebSocket Closed:', e?.code, e?.reason);
//   };

//   useEffect(() => {
//     setupWebSocket();
//     return () => wse.current?.close();
//   }, [number]);
...
//     setLoading(true);
//     try {
//       // find the oldest chat date
//       const oldestDate = new Date(
//         chats.reduce(
//           (oldest, curr) =>
//             new Date(curr.ProcessDate) < new Date(oldest.ProcessDate)
//               ? curr
//               : oldest,
//           chats[0],
//         ).ProcessDate,
...
//             SenderId: user.WhatsAppSenderID,
//             ClientId: number,
//             Date: oldestDate, // get older than this date
//           }),
//         },
//       );
...
//       // prepend older chats to existing ones
//       setChats(prev =>
...
//       if (wse.current && wse.current.readyState === WebSocket.OPEN) {
//         wse.current.send(JSON.stringify(payload));
//       } else {
//         setupWebSocket();
//         setTimeout(() => {
//           if (wse.current?.readyState === WebSocket.OPEN)
//             wse.current.send(JSON.stringify(payload));
//         }, 2000);
//       }
...
//           <FlatList
//             ref={flatListRef}
//             data={[...flatData].reverse()} // reversed so latest at bottom
//             keyExtractor={(item, index) =>
//               item.Uid || `chat-${index}-${item.date || 'msg'}`
//             }
//             renderItem={({ item }) => <ChatItem item={item} />}
//             contentContainerStyle={{ paddingVertical: 10 }}
//             inverted // keeps latest chats at the bottom
...
//               fetchOlderChats(); // fetches older chats when scrolling up
//             }}
//             ListFooterComponent={
//               loading ? (
//                 <ActivityIndicator
...
//   //   console.log('Closing WebSocket connection for chat with', number);
//   //   if (wse.current) {
//   //     wse.current.close();
//   //     wse.current = null;
//   //   }
...
//     if (wse.current) {
//       const state = wse.current.readyState;
//       console.log('WebSocket readyState before closing:', state);

//       try {
//         if (state === WebSocket.OPEN || state === WebSocket.CONNECTING) {
//           wse.current.close(1000, 'Chat closed by user'); // normal closure
//         } else {
//           console.log('WebSocket already closed or closing, skipping close()');
//         }
//       } catch (err) {
...
//   //   console.log('Building WebSocket connection for chat with', number);
//   //   if (wse.current) {
//   //     wse.current.close();
//   //     wse.current = null;
//   //   }
...
//   //   wse.current.onopen = () => {
//   //     console.log('WebSocket Connected for chat with', number);
//   //     fetchChats();
//   //   };
//   //   wse.current.onmessage = e => {
//   //     try {
...
//   //   wse.current.onclose = e => {
//   //     console.warn(
//   //       'WebSocket Closed for chat with',
//   //       number,
//   //       ':',
//   //       e.code,
//   //       e.reason,
...
//   //         console.log(
//   //           'Attempting WebSocket reconnection for chat with',
//   //           number,
//   //           '...',
//   //         );
//   //         setupWebSocket();
...
//     // Proper cleanup of previous socket
//     if (wse.current) {
